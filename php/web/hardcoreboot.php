...
<a name="home"></a>
 ...
 //
 echo ' <div class="mt-3 card-deck row">';
 ...
 if ($result->num_rows > 0) {
     ...
     while($row = $result->fetch_assoc()) {
       ...
       echo '<div class="card btn-dark col-md-4">';
       ...
       echo "" . $row["id"]. "<br> " . $row["tittle"]. "<br> " . $row["info"];
       echo '</h5>';
       echo '</a>';
       echo '<br>';
       echo '<div>';
       echo "<img width='200%' alt='Card image cap' src=NEWS/img/" . $row["img"] . "> <br>";
         ?>
