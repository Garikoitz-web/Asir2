...
<div class="h-content">
	...
	<div class="p-top">
	<div class="p-foto"><img src="img/<?php echo $rowA['avatar'];?>" width="180" height="180"></div>
		<div class="p-name">
			...
			<div class="p-editar"><a href="editar_perfil.php"><button class="button_white">Edit Profile</button></a></div>
			<?php } else { ?>
